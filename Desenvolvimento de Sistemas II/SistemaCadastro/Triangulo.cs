...
namespace SistemaCadastro
{
    public partial class Triangulo : Form
    {
        ...
        private void BtnResultado_Click(object sender, EventArgs e)
        {
            ...
            if (l1==l2 && l2==l3)
            {
                ImgTriangulo.Image = SistemaCadastro.Properties.Resources.TRIANGULO_EQUILATERO;
                

            }
            else if(l1!=l2 && l2!=l3 && l3 != l1)
            {
                ImgTriangulo.Image = SistemaCadastro.Properties.Resources.TRIANGULO_ESCALENO;
                
            }
            else
            {
                ImgTriangulo.Image = SistemaCadastro.Properties.Resources.TRIANGULO_ACUTANGULO;
